...
class EquineUpdate {
  ...
  final String? birthDateIsApproximate;
  ...
  final String? workloadLast7Days;
  ...
  factory EquineUpdate.fromJson(Map<String, dynamic> json) {
    return EquineUpdate(
      ...
      birthDateIsApproximate: json['birth_date_is_approximate'] as String?,
      ...
      workloadLast7Days: json['workload_last_7_days'] as String?,
