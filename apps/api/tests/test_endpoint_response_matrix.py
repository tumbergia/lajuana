...
PROTECTED_ENDPOINTS = [
    ...
    ("post", "/api/v1/users", {"email": "u@test.com", "full_name": "Usuario Test", "password": "Segura123", "role": "guide"}),
    ("get", "/api/v1/users", None),
    ("get", f"/api/v1/users/{FAKE_ID}", None),
    ("patch", f"/api/v1/users/{FAKE_ID}", {"full_name": "Nuevo Nombre"}),
    ("delete", f"/api/v1/users/{FAKE_ID}", None),
    ("post", "/api/v1/experiences", {"name": "Cabalgata", "slug": "cabalgata", "description": "Ruta corta", "level": "basic", "duration_hours": 2}),
    ...
    ("post", "/api/v1/schedules", {"experience_id": FAKE_ID, "date": "2026-05-20", "start_time": "08:00:00", "capacity_total": 8}),
    ...
    ("post", "/api/v1/reservations", {"experience_id": FAKE_ID, "participant_count": 2, "channel": "whatsapp"}),
    ...
    ("post", "/api/v1/assignments", {"reservation_id": FAKE_ID, "participant_id": FAKE_ID, "equine_id": FAKE_ID}),
    ("get", f"/api/v1/assignments/{FAKE_ID}", None),
    ("patch", f"/api/v1/assignments/{FAKE_ID}", {"notes": "Ajuste de ultima hora"}),
    ("post", "/api/v1/logs", {"reservation_id": FAKE_ID, "event_type": "note", "happened_at": "2026-05-20T08:00:00Z"}),
...
GUIDE_FORBIDDEN_ENDPOINTS = [
    ("post", "/api/v1/users", {"email": "x@y.com", "full_name": "X Y", "password": "Segura123", "role": "guide"}),
    ("get", "/api/v1/users", None),
    ("post", f"/api/v1/reservations/{FAKE_ID}/confirm", {}),
    ("patch", "/api/v1/config/reservation-rules", {"min_days_in_advance": 3}),
    ("post", "/api/v1/experiences", {"name": "Ruta", "slug": "ruta-1", "description": "Desc", "level": "basic", "duration_hours": 2}),
    ("delete", f"/api/v1/providers/{FAKE_ID}", None),
]
