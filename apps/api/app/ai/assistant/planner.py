...
_ADMIN_TOOL_CATEGORIES: dict[str, list[str]] = {
    ...
    "grafica": ["admin_get_sales_summary", "admin_get_reservation_funnel", "admin_get_channel_performance", "admin_get_occupancy_report", "admin_get_equine_workload_report"],
    "gráfica": ["admin_get_sales_summary", "admin_get_reservation_funnel", "admin_get_channel_performance", "admin_get_occupancy_report", "admin_get_equine_workload_report"],
    "analitica": ["admin_get_sales_summary", "admin_get_reservation_funnel", "admin_get_channel_performance", "admin_get_occupancy_report", "admin_get_equine_workload_report"],
    "analítica": ["admin_get_sales_summary", "admin_get_reservation_funnel", "admin_get_channel_performance", "admin_get_occupancy_report", "admin_get_equine_workload_report"],
