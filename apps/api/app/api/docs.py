...
ENDPOINT_DOCS: dict[str, EndpointDoc] = {
    ...
    "role_requests_create": {
        "summary": "Solicitar rol",
        "description": "Permite a un usuario sin rol solicitar Guía o Administrador.",
        "permissions": ["role_request.create_self"],
        "responses": {
            201: "Solicitud creada correctamente.",
            401: "No autenticado.",
            403: "Sin permisos.",
            409: "Ya existe una solicitud pendiente o el usuario ya tiene rol.",
            422: "Datos inválidos.",
        },
        "error_codes": [
            "auth.unauthorized",
            "auth.forbidden",
            "role_request.not_allowed",
            "role_request.already_pending",
            "role_request.invalid_role",
            "common.validation_error",
        ],
        "service_docstring": "Crea solicitud de rol y notifica a administradores.",
    },
    "role_requests_me": {
        "summary": "Consultar mi solicitud de rol",
        "description": "Retorna la solicitud de rol más reciente del usuario autenticado.",
        "permissions": [],
        "responses": {
            200: "Solicitud obtenida (o null si no existe).",
            401: "No autenticado.",
        },
        "error_codes": ["auth.unauthorized"],
        "service_docstring": "Consulta la solicitud propia más reciente.",
    },
    "role_requests_list": {
        "summary": "Listar solicitudes de rol",
        "description": "Lista solicitudes de rol para revisión administrativa.",
        "permissions": ["role_request.read"],
        "responses": {
            200: "Listado de solicitudes obtenido correctamente.",
            401: "No autenticado.",
            403: "Sin permisos.",
        },
        "error_codes": ["auth.unauthorized", "auth.forbidden"],
        "service_docstring": "Lista solicitudes filtradas por estado.",
    },
    "role_requests_decide": {
        "summary": "Resolver solicitud de rol",
        "description": "Aprueba (asignando el rol pedido u otro) o rechaza una solicitud.",
        "permissions": ["role_request.manage"],
        "responses": {
            200: "Solicitud resuelta correctamente.",
            401: "No autenticado.",
            403: "Sin permisos.",
            404: "Solicitud no encontrada.",
            409: "La solicitud ya fue resuelta.",
            422: "Datos inválidos.",
        },
        "error_codes": [
            "auth.unauthorized",
            "auth.forbidden",
            "role_request.not_found",
            "role_request.not_pending",
            "role_request.invalid_role",
            "role_request.invalid_action",
            "user.not_found",
            "common.validation_error",
        ],
        "service_docstring": "Aprueba o rechaza solicitud y notifica al solicitante.",
    },
    "experiences_create": {
    ...
    "reservations_timeline": {
        "summary": "Bitácora de la reserva",
        "description": (
            "Retorna el historial cronológico unificado: eventos operativos, "
            "cambios de ciclo de vida y notas manuales."
        ),
        "permissions": ["reservation.read"],
        "responses": {
            200: "Bitácora obtenida correctamente.",
            401: "No autenticado.",
            403: "Sin permisos.",
            404: "Reserva no existe.",
        },
        "error_codes": ["auth.unauthorized", "auth.forbidden", "reservation.not_found"],
        "service_docstring": "Construye timeline unificado de la reserva.",
    },
    "reservations_providers_list": {
        "summary": "Proveedores de la reserva",
        "description": "Lista proveedores asociados a una reserva con datos de contacto planos.",
        "permissions": ["reservation.read"],
        "responses": {
        ...
        "error_codes": ["auth.unauthorized", "auth.forbidden", "reservation.not_found"],
        "service_docstring": "Lista asociaciones reserva-proveedor enriquecidas.",
    },
    "reservations_providers_create": {
        "summary": "Asociar proveedor a reserva",
        "description": "Crea una asociación operativa entre reserva y proveedor.",
        "permissions": ["reservation.update"],
        "responses": {
            201: "Asociación creada correctamente.",
            401: "No autenticado.",
            403: "Sin permisos.",
            404: "Reserva o proveedor no existe.",
            409: "Proveedor no asociable o duplicado.",
            422: "Datos inválidos.",
        },
        "error_codes": [
            "auth.unauthorized",
            ...
            "provider.not_found",
            "provider.not_associable",
            "reservation_provider.duplicate",
            "common.validation_error",
        ],
        "service_docstring": "Asocia proveedor a reserva con validaciones mínimas.",
    },
    "reservations_providers_update": {
        "summary": "Actualizar asociación reserva-proveedor",
        "description": "Actualiza servicio, notas o estado de la asociación.",
        "permissions": ["reservation.update"],
        "responses": {
            200: "Asociación actualizada correctamente.",
            401: "No autenticado.",
            403: "Sin permisos.",
            404: "Reserva o asociación no existe.",
            409: "Duplicado de servicio.",
            422: "Datos inválidos.",
        },
        "error_codes": [
            "auth.unauthorized",
            "auth.forbidden",
            "reservation.not_found",
            "reservation_provider.not_found",
            "reservation_provider.duplicate",
            "common.validation_error",
        ],
        "service_docstring": "Actualiza asociación reserva-proveedor.",
    },
    "reservations_providers_delete": {
        "summary": "Quitar proveedor de reserva",
        "description": "Elimina la asociación reserva-proveedor.",
        "permissions": ["reservation.update"],
        "responses": {
            200: "Asociación eliminada correctamente.",
            401: "No autenticado.",
            403: "Sin permisos.",
            404: "Reserva o asociación no existe.",
        },
        ...
        "service_docstring": "Elimina asociación reserva-proveedor.",
    },
    "reservations_update": {
    ...
    "equines_timeline": {
        ...
        "error_codes": ["auth.unauthorized", "equine.not_found"],
        "service_docstring": "Obtiene timeline unificado de un equino.",
    },
    "equine_events_create": {
        "summary": "Registrar evento de equino",
        "description": "Registra un evento de cuidado/seguimiento sin requerir reserva.",
        "permissions": ["equine.update"],
        "responses": {
            201: "Evento registrado correctamente.",
            401: "No autenticado.",
            403: "Sin permisos.",
            404: "Equino o reserva no encontrados.",
            400: "Validación de evento incumplida.",
            422: "Datos inválidos.",
        },
        "error_codes": [
            "auth.unauthorized",
            ...
            "equine_event.invalid_happened_at",
            "equine_event.weight_required",
            "equine_event.height_required",
            "equine_event.availability_fields_required",
            "equine_event.assignment_equine_mismatch",
            "common.validation_error",
        ],
        "service_docstring": "Crea evento de cuidado para un equino.",
    },
    "equine_events_list": {
        "summary": "Listar eventos de equino",
        "description": "Lista eventos de cuidado de un equino con filtros opcionales.",
        "permissions": ["equine.read"],
        "responses": {
            200: "Listado obtenido correctamente.",
            401: "No autenticado.",
        ...
        "error_codes": ["auth.unauthorized", "equine.not_found"],
        "service_docstring": "Lista eventos de equino filtrados.",
    },
    "equine_events_get": {
        "summary": "Obtener evento de equino",
        "description": "Retorna un evento de cuidado por ID.",
        "permissions": ["equine.read"],
        "responses": {
        ...
        "error_codes": ["auth.unauthorized", "equine_event.not_found"],
        "service_docstring": "Obtiene evento de equino por ID.",
    },
    "equine_events_update": {
        "summary": "Actualizar evento de equino",
        "description": "Actualiza parcialmente un evento de cuidado.",
        "permissions": ["equine.update"],
        "responses": {
        ...
        "service_docstring": "Actualiza evento de equino con re-validación.",
    },
    "equine_events_delete": {
        "summary": "Eliminar evento de equino",
        "description": "Borrado lógico de un evento de cuidado.",
        "permissions": ["equine.delete"],
        "responses": {
            200: "Evento eliminado correctamente.",
            401: "No autenticado.",
            404: "Evento no encontrado.",
        },
        "error_codes": ["auth.unauthorized", "equine_event.not_found"],
        "service_docstring": "Soft-delete de evento de equino.",
    },
    ...
    "saddles_available_for_reservation": {
        ...
        "description": "Retorna sillas con block_reason para una reserva.",
        "permissions": ["saddle.read"],
        "responses": {
            200: "Listado de sillas disponibles.",
            401: "No autenticado.",
        ...
        "service_docstring": "Obtiene sillas disponibles para una reserva.",
    },
    "assignments_create": {
        "summary": "Registrar asignacion operativa (solo admin)",
        "description": "Registra asignacion de participante, equino y silla. Solo administradores.",
        ...
        "service_docstring": "Registra asignacion operativa con validaciones de seguridad. Solo admin.",
    },
    "assignments_get": {
    ...
    "assignments_update": {
        "summary": "Actualizar asignacion operativa (solo admin)",
        "description": "Actualiza una asignacion existente con revalidacion de recursos. Solo administradores.",
        ...
        "service_docstring": "Actualiza asignacion validando coherencia operativa. Solo admin.",
    },
    "assignments_finalize": {
        "summary": "Finalizar asignacion (solo admin)",
        "description": "Cambia el estado de CONFIRMED a FINAL. Solo administradores.",
        "permissions": ["assignment.update"],
        "responses": {
            200: "Asignacion finalizada correctamente.",
            401: "No autenticado.",
            403: "Sin permisos (solo admin).",
            404: "Asignacion no encontrada.",
            409: "Asignacion no esta en estado CONFIRMED.",
        },
        "error_codes": [
            "auth.unauthorized",
            "auth.forbidden",
            "assignment.not_found",
            "assignment.reservation_not_confirmed",
        ],
        "service_docstring": "Finaliza asignacion. Solo admin.",
    },
    "assignments_unfinalize": {
        "summary": "Revertir finalizacion de asignacion (solo admin)",
        "description": "Cambia el estado de FINAL a CONFIRMED. Solo administradores.",
        "permissions": ["assignment.update"],
        "responses": {
            200: "Finalizacion revertida correctamente.",
            401: "No autenticado.",
            403: "Sin permisos (solo admin).",
            404: "Asignacion no encontrada.",
            409: "La asignacion no esta finalizada.",
        },
        "error_codes": [
            "auth.unauthorized",
            "auth.forbidden",
        ...
        "service_docstring": "Revierte la finalizacion de una asignacion. Solo admin.",
    },
    "assignments_delete": {
        "summary": "Quitar asignacion (solo admin)",
        "description": "Marca la asignacion como cancelada y la saca del tablero. Solo administradores.",
        "permissions": ["assignment.update"],
        "responses": {
            200: "Asignacion quitada correctamente.",
            401: "No autenticado.",
            403: "Sin permisos (solo admin).",
            404: "Asignacion no encontrada.",
            409: "La asignacion no puede quitarse en su estado actual.",
        },
        "error_codes": [
            "auth.unauthorized",
            "auth.forbidden",
        ...
        "service_docstring": "Quita una asignacion del tablero. Solo admin.",
    },
    "assignments_board": {
        "summary": "Tablero de asignacion por reserva",
        "description": "Retorna participantes, asignaciones, equinos y sillas disponibles.",
        "permissions": ["assignment.read"],
        "responses": {
            200: "Tablero obtenido correctamente.",
            401: "No autenticado.",
            403: "Sin permisos.",
            404: "Reserva no encontrada.",
        },
        ...
        "service_docstring": "Obtiene tablero de asignaciones.",
    },
    "assignments_replace": {
        "summary": "Reemplazar asignacion (solo admin)",
        "description": "Reemplaza una asignacion finalizada: desactiva la actual y crea una nueva. Solo administradores.",
        "permissions": ["assignment.create", "assignment.update"],
        "responses": {
            201: "Reemplazo creado correctamente, asignacion anterior desactivada.",
            401: "No autenticado.",
            403: "Sin permisos (solo admin).",
            404: "Asignacion no encontrada.",
            409: "La asignacion no esta finalizada.",
        ...
        "service_docstring": "Reemplaza asignacion finalizada. Solo admin.",
    },
    "logs_create": {
    ...
    "logs_list": {
        "summary": "Listar eventos de bitácora por reserva",
        "description": "Retorna eventos de bitácora operativa filtrados por reserva.",
        "permissions": ["log.read"],
        "responses": {
            200: "Eventos obtenidos correctamente.",
            401: "No autenticado.",
            403: "Sin permisos.",
            404: "Reserva no existe.",
        },
        "error_codes": ["auth.unauthorized", "auth.forbidden", "reservation.not_found"],
        "service_docstring": "Lista service logs de una reserva.",
    },
    "logs_get": {
    ...
    "logs_delete": {
        "summary": "Eliminar evento de bitácora",
        "description": "Borra lógicamente un evento de bitácora. Notas manuales: guía o admin. Automáticos: solo admin.",
        "permissions": ["log.update"],
        "responses": {
            200: "Evento eliminado correctamente.",
            401: "No autenticado.",
        ...
        "error_codes": ["auth.unauthorized", "auth.forbidden", "log.not_found"],
        "service_docstring": "Soft delete de service log con reglas por tipo.",
    },
    "logs_photo_upload": {
        "summary": "Subir foto para bitácora",
        "description": "Sube una imagen asociada a una reserva antes de crear o editar una nota manual.",
        "permissions": ["log.create"],
        "responses": {
        ...
        "error_codes": [
            ...
            "auth.forbidden",
            "reservation.not_found",
            "log.photo_invalid_type",
            "log.photo_limit",
        ],
        "service_docstring": "Almacena foto temporal para nota de bitácora.",
    },
    "logs_photo_download": {
        "summary": "Descargar foto de bitácora",
        "description": "Descarga una foto adjunta a una entrada de bitácora por índice.",
        "permissions": ["log.read"],
        "responses": {
            200: "Archivo descargado correctamente.",
            401: "No autenticado.",
            403: "Sin permisos.",
            404: "Entrada o foto no existe.",
        },
        "error_codes": [
            "auth.unauthorized",
            "auth.forbidden",
        ...
        "service_docstring": "Lee bytes de foto almacenada en service log.",
    },
    "providers_create": {
    ...
    "providers_list": {
        ...
        "description": "Lista proveedores con filtros por tipo, estado, categoría y texto.",
        ...
        "error_codes": ["auth.unauthorized", "auth.forbidden"],
        "service_docstring": "Lista proveedores del catálogo operativo.",
    },
    "providers_get": {
...
ENDPOINT_ROUTE_MAP: dict[str, tuple[str, str]] = {
    ...
    "role_requests_create": ("POST", "/api/v1/role-requests"),
    "role_requests_me": ("GET", "/api/v1/role-requests/me"),
    "role_requests_list": ("GET", "/api/v1/role-requests"),
    "role_requests_decide": ("POST", "/api/v1/role-requests/{request_id}/decide"),
    ...
    "reservations_timeline": ("GET", "/api/v1/reservations/{reservation_id}/timeline"),
    "reservations_providers_list": ("GET", "/api/v1/reservations/{reservation_id}/providers"),
    "reservations_providers_create": ("POST", "/api/v1/reservations/{reservation_id}/providers"),
    "reservations_providers_update": (
        "PATCH",
        "/api/v1/reservations/{reservation_id}/providers/{reservation_provider_id}",
    ),
    "reservations_providers_delete": (
        "DELETE",
        "/api/v1/reservations/{reservation_id}/providers/{reservation_provider_id}",
    ...
    "equine_events_create": ("POST", "/api/v1/equines/{equine_id}/events"),
    "equine_events_list": ("GET", "/api/v1/equines/{equine_id}/events"),
    "equine_events_get": ("GET", "/api/v1/equine-events/{event_id}"),
    "equine_events_update": ("PATCH", "/api/v1/equine-events/{event_id}"),
    "equine_events_delete": ("DELETE", "/api/v1/equine-events/{event_id}"),
    "equines_available_for_reservation": (
        "GET",
    ...
    "assignments_finalize": ("POST", "/api/v1/assignments/{assignment_id}/finalize"),
    "assignments_unfinalize": ("POST", "/api/v1/assignments/{assignment_id}/unfinalize"),
    "assignments_delete": ("DELETE", "/api/v1/assignments/{assignment_id}"),
    "assignments_board": ("GET", "/api/v1/assignments/board/{reservation_id}"),
    "assignments_replace": ("POST", "/api/v1/assignments/{assignment_id}/replace"),
    "logs_create": ("POST", "/api/v1/logs"),
    "logs_list": ("GET", "/api/v1/logs"),
    "logs_get": ("GET", "/api/v1/logs/{log_id}"),
    "logs_update": ("PATCH", "/api/v1/logs/{log_id}"),
    "logs_delete": ("DELETE", "/api/v1/logs/{log_id}"),
    "logs_photo_upload": ("POST", "/api/v1/logs/photos/upload"),
    "logs_photo_download": ("GET", "/api/v1/logs/{log_id}/photos/{photo_index}/download"),
    "providers_create": ("POST", "/api/v1/providers"),
    "providers_list": ("GET", "/api/v1/providers"),
