...
ERROR_CODE_CONTRACT_RULE = (
    "Frontend y tests dependen de error_codes, no del texto del mensaje."
)
...
ENDPOINT_DOCS: dict[str, EndpointDoc] = {
    ...
    "auth_change_password": {
        ...
        "description": (
            "Cambia la contraseña del usuario autenticado validando la clave actual."
        ),
    ...
    "auth_me": {
        ...
        "error_codes": ["auth.unauthorized", "auth.invalid_token", "auth.expired_token", "user.not_found"],
    ...
    "users_list": {
        ...
        "responses": {200: "Listado de usuarios obtenido correctamente.", 401: "No autenticado.", 403: "Sin permisos."},
    ...
    "users_get": {
        ...
        "permissions": ["user.read"],
        "responses": {200: "Usuario obtenido correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Usuario no existe."},
    ...
    "users_delete": {
        ...
        "responses": {200: "Usuario desactivado correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Usuario no existe.", 409: "No se permite autoeliminacion."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "user.not_found", "user.self_delete_forbidden"],
    ...
    "experiences_create": {
        ...
        "responses": {201: "Experiencia creada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 409: "Slug duplicado.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "experience.slug_already_exists", "experience.invalid_duration", "experience.invalid_capacity", "common.validation_error"],
    ...
    "experiences_list": {
        ...
        "responses": {200: "Listado de experiencias obtenido correctamente.", 401: "No autenticado."},
    ...
    "experiences_get": {
        ...
        "permissions": ["experience.read"],
        "responses": {200: "Experiencia obtenida correctamente.", 401: "No autenticado.", 404: "Experiencia no existe."},
    ...
    "experiences_update": {
        ...
        "responses": {200: "Experiencia actualizada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Experiencia no existe.", 409: "Slug duplicado.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "experience.not_found", "experience.slug_already_exists", "experience.invalid_duration", "experience.invalid_capacity", "common.validation_error"],
    ...
    "experiences_delete": {
        ...
        "responses": {200: "Experiencia desactivada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Experiencia no existe."},
    ...
    "schedules_create": {
        ...
        "responses": {201: "Fecha operativa creada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Experiencia no existe.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "experience.not_found", "schedule.invalid_capacity", "schedule.invalid_slot_values", "schedule.negative_availability", "schedule.invalid_status", "common.validation_error"],
    ...
    "schedules_list": {
        ...
        "responses": {200: "Listado de fechas operativas obtenido correctamente.", 401: "No autenticado."},
        "error_codes": ["auth.unauthorized"],
    ...
    "schedules_get": {
        ...
        "permissions": ["schedule.read"],
        "responses": {200: "Fecha operativa obtenida correctamente.", 401: "No autenticado.", 404: "Fecha operativa no existe."},
    ...
    "schedules_update": {
        ...
        "responses": {200: "Fecha operativa actualizada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Fecha operativa no existe.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "schedule.not_found", "schedule.invalid_capacity", "schedule.invalid_slot_values", "schedule.negative_availability", "schedule.invalid_status", "common.validation_error"],
    ...
    "schedules_delete": {
        ...
        "responses": {200: "Fecha operativa desactivada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Fecha operativa no existe."},
    ...
    "reservations_create": {
        ...
        "responses": {201: "Reserva creada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Experiencia o fecha operativa no existe.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "experience.not_found", "schedule.not_found", "reservation.invalid_participant_count", "reservation.schedule_mismatch", "common.validation_error"],
    ...
    "reservations_list": {
        ...
        "responses": {200: "Listado de reservas obtenido correctamente.", 401: "No autenticado.", 403: "Sin permisos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden"],
    ...
    "reservations_get": {
        ...
        "permissions": ["reservation.read"],
        "responses": {200: "Reserva obtenida correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Reserva no existe."},
    ...
    "reservations_update": {
        ...
        "responses": {200: "Reserva actualizada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Reserva no existe.", 409: "Conflicto de estado.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "reservation.not_found", "reservation.invalid_status_transition", "reservation.already_cancelled", "reservation.already_completed", "reservation.invalid_participant_count", "common.validation_error"],
    ...
    "reservations_confirm": {
        ...
        "responses": {200: "Reserva confirmada correctamente.", 400: "Reglas de negocio incumplidas.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Reserva o schedule no existe.", 409: "Conflicto de estado o disponibilidad."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "reservation.not_found", "schedule.not_found", "reservation.invalid_status_transition", "reservation.confirmation_not_allowed", "reservation.min_notice_violation", "reservation.no_availability", "reservation.payment_required", "reservation.payment_not_verified", "schedule.not_open", "schedule.already_full", "participant.operationally_incomplete"],
    ...
    "reservations_cancel": {
        ...
        "responses": {200: "Reserva cancelada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Reserva no existe.", 409: "No puede cancelarse en estado actual."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "reservation.not_found", "reservation.cancellation_not_allowed", "reservation.already_cancelled", "reservation.already_completed"],
    ...
    "reservation_payment_proofs_create": {
        ...
        "responses": {201: "Comprobante asociado correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Reserva no existe.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "reservation.not_found", "payment_proof.storage_key_required", "payment_proof.invalid_content_type", "payment_proof.invalid_size", "payment_proof.hash_required", "common.validation_error"],
    ...
    "payment_proofs_get": {
        ...
        "responses": {200: "Comprobante obtenido correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Comprobante no existe."},
    ...
    "payment_proofs_update": {
        ...
        "responses": {200: "Comprobante actualizado correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Comprobante o reserva no existe.", 409: "Inconsistencia entre comprobante y reserva."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "payment_proof.not_found", "reservation.not_found", "payment_proof.reservation_mismatch"],
    ...
    "participants_create": {
        ...
        "responses": {201: "Participante registrado correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Reserva no existe.", 400: "Reglas operativas incumplidas.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "reservation.not_found", "participant.invalid_birth_date", "participant.invalid_weight", "participant.invalid_height", "participant.data_processing_required", "participant.missing_required_fields", "participant.operationally_incomplete", "common.validation_error"],
    ...
    "participants_get": {
        ...
        "responses": {200: "Participante obtenido correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Participante no existe."},
    ...
    "participants_update": {
        ...
        "responses": {200: "Participante actualizado correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Participante no existe.", 400: "Reglas operativas incumplidas.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "participant.not_found", "participant.invalid_birth_date", "participant.invalid_weight", "participant.invalid_height", "participant.data_processing_required", "participant.missing_required_fields", "common.validation_error"],
    ...
    "equines_create": {
        ...
        "responses": {201: "Equino creado correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "equine.invalid_weight", "common.validation_error"],
    ...
    "equines_get": {
        ...
        "permissions": ["equine.read"],
        "responses": {200: "Equino obtenido correctamente.", 401: "No autenticado.", 404: "Equino no existe."},
    ...
    "equines_update": {
        ...
        "responses": {200: "Equino actualizado correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Equino no existe.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "equine.not_found", "equine.invalid_weight", "common.validation_error"],
    ...
    "equines_delete": {
        ...
        "permissions": ["equine.update"],
        "responses": {200: "Equino desactivado correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Equino no existe."},
    ...
    "saddles_create": {
        ...
        "responses": {201: "Silla creada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 409: "Código duplicado.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "saddle.code_already_exists", "common.validation_error"],
    ...
    "saddles_get": {
        ...
        "permissions": ["saddle.read"],
        "responses": {200: "Silla obtenida correctamente.", 401: "No autenticado.", 404: "Silla no existe."},
    ...
    "saddles_update": {
        ...
        "responses": {200: "Silla actualizada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Silla no existe.", 409: "Código duplicado.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "saddle.not_found", "saddle.code_already_exists", "common.validation_error"],
    ...
    "assignments_create": {
        ...
        "responses": {201: "Asignacion registrada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Recurso relacionado no existe.", 409: "Conflicto por recurso asignado o no disponible.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "reservation.not_found", "participant.not_found", "equine.not_found", "saddle.not_found", "assignment.participant_not_in_reservation", "assignment.equine_already_assigned", "assignment.saddle_already_assigned", "assignment.invalid_priority", "equine.unavailable", "saddle.unavailable", "common.validation_error"],
    ...
    "assignments_get": {
        ...
        "responses": {200: "Asignacion obtenida correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Asignacion no existe."},
    ...
    "assignments_update": {
        ...
        "responses": {200: "Asignacion actualizada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Asignacion o recurso no existe.", 409: "Conflicto por recurso asignado o no disponible.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "assignment.not_found", "equine.not_found", "saddle.not_found", "assignment.equine_already_assigned", "assignment.saddle_already_assigned", "equine.unavailable", "saddle.unavailable", "common.validation_error"],
    ...
    "logs_create": {
        ...
        "responses": {201: "Evento registrado correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Reserva no existe.", 400: "Regla de evento incumplida.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "reservation.not_found", "log.invalid_event_type", "log.checkpoint_name_required", "common.validation_error"],
    ...
    "logs_get": {
        ...
        "responses": {200: "Evento obtenido correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Evento no existe."},
    ...
    "logs_update": {
        ...
        "responses": {200: "Evento actualizado correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Evento no existe.", 400: "Regla de evento incumplida.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "log.not_found", "log.invalid_event_type", "log.checkpoint_name_required", "common.validation_error"],
    ...
    "providers_create": {
        ...
        "responses": {201: "Proveedor creado correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 422: "Datos inválidos."},
    ...
    "providers_get": {
        ...
        "responses": {200: "Proveedor obtenido correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Proveedor no existe."},
    ...
    "providers_update": {
        ...
        "responses": {200: "Proveedor actualizado correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Proveedor no existe.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "provider.not_found", "common.validation_error"],
    ...
    "providers_delete": {
        ...
        "responses": {200: "Proveedor desactivado correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Proveedor no existe."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "provider.not_found"],
    ...
    "policies_create": {
        ...
        "responses": {201: "Póliza registrada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Reserva o proveedor no existe.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "reservation.not_found", "provider.not_found", "common.validation_error"],
    ...
    "policies_get": {
        ...
        "responses": {200: "Póliza obtenida correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Póliza no existe."},
    ...
    "policies_update": {
        ...
        "responses": {200: "Póliza actualizada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Póliza no existe.", 409: "Inconsistencia de reserva.", 422: "Datos inválidos."},
        "error_codes": ["auth.unauthorized", "auth.forbidden", "policy.not_found", "policy.reservation_mismatch", "common.validation_error"],
    ...
    "config_get": {
        ...
        "responses": {200: "Configuración obtenida correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Configuración no existe."},
    ...
    "config_update": {
        ...
        "responses": {200: "Configuración actualizada correctamente.", 401: "No autenticado.", 403: "Sin permisos.", 404: "Configuración no existe.", 400: "Regla de negocio inválida.", 422: "Datos inválidos."},
...
def _error_examples_for_status(key: str, status_code: int) -> dict[str, dict[str, object]]:
    ...
    for case_id in case_ids:
        case = BUSINESS_ERROR_CASES[case_id]
        details = {detail_key: _detail_example_value(detail_key) for detail_key in case["detail_keys"]}
        examples[case_id] = {
            "summary": case["name"],
            "value": {
                "code": case["code"],
