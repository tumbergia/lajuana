...
ENDPOINT_DOCS: dict[str, EndpointDoc] = {
    ...
    "assignments_finalize": {
        "summary": "Finalizar asignacion",
        "description": "Cambia el estado de CONFIRMED a FINAL. Solo permite cambios de nota post-finalizacion.",
        "permissions": ["assignment.update"],
        "responses": {
        ...
        "service_docstring": "Finaliza asignacion.",
    },
    "assignments_board": {
