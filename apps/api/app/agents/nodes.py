...
async def ops_agent_node(state: GraphState, deps: NodeDependencies, config: RunnableConfig) -> dict[str, Any]:
    ...
    system_prompt = SystemMessage(content=(
        ...
        "de los guías y administradores a llamadas estructuradas usando tu única "
        "herramienta de administración. Infieres correctamente la entidad y la acción "
        "solicitada, y confirmas al usuario de forma humanizada."
    ))
...
async def tourist_agent_node(state: GraphState, deps: NodeDependencies, config: RunnableConfig) -> dict[str, Any]:
