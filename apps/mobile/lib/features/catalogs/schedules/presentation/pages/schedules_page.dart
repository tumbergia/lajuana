...
import 'package:mobile/features/catalogs/schedules/presentation/widgets/schedule_card.dart';
...
class _SchedulesPageState extends State<SchedulesPage> {
  ...
  void initState() {
    ...
    _controller = SchedulesController(
      repository: widget.module.schedules,
          ...
          child: Column(
            ...
            children: [
              AppSectionHeader(
                ...
                subtitle: 'Disponibilidad y cupos por salida',
                trailing: Wrap(
                  spacing: 8,
                  children: [
                    AppButton(
