...
import 'package:mobile/auth/infrastructure/remote/auth_api_client.dart';
import 'package:mobile/auth/presentation/auth_controller.dart';
import 'package:mobile/auth/presentation/screens/authenticated_home_screen.dart';
...
void main() {
  ...
  testWidgets('Authenticated home no renderiza FAB de sesion', (tester) async {
